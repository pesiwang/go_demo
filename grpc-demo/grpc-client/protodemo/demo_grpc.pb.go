...
type DemoServiceClient interface {
	GetData(ctx context.Context, in *DemoReq, opts ...grpc.CallOption) (*DemoRsp, error)
}
...
func (c *demoServiceClient) GetData(ctx context.Context, in *DemoReq, opts ...grpc.CallOption) (*DemoRsp, error) {
	out := new(DemoRsp)
	err := c.cc.Invoke(ctx, "/proto.DemoService/GetData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DemoServiceServer interface {
	GetData(context.Context, *DemoReq) (*DemoRsp, error)
}
...
func (UnimplementedDemoServiceServer) GetData(context.Context, *DemoReq) (*DemoRsp, error) {
...
func _DemoService_GetData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.DemoService/GetData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServiceServer).GetData(ctx, req.(*DemoReq))
	}
